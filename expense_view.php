...
<div class="panel panel-default">
   <div class="panel-heading"><h2>ALL EXPENSES</h2> </div>
  <div class="panel-body">
    <p>Summary of all the expenses are listed below:</p>
  </div>
...
<div class="row">
        ...
        <a href="login/add_expense.html"><button type="button" class="btn btn-primary col-lg-1 col-lg-offset-2">ADD EXPENSE</button></a>
 	</div>
</div>
</div>
</div>
